...
spb_smbc_dapc_lds_simulated <- spb_smbc_dapc_lds %>%
  filter(pop == "Simulated BC SMBC" |
           pop == "Simulated BC SPB" |
           pop == "Simulated F1" |
           pop == "Simulated F2" |
           pop == "Simulated Pure SMBC" |
           pop == "Simulated Pure SPB")

# Plot only simulated individuals
pdf("figures/02_spb_smbc_simulated_dapc.pdf", width=8, height=6)

ggplot(spb_smbc_dapc_lds_simulated, aes(x = LD1, y = LD2, fill = pop)) +
...
pdf("figures/02_spb_smbc_all_dapc.pdf", width=8, height=6)
