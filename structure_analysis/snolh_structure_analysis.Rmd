...
##### 1b.1. The metadata is saved as the .Rda file `../processed_raw_data/snolh_all_metadata.rda`, which can be loaded independently for downstream analyses. The associated R object is called "metadata"
...
save(full_data, file = "../raw_data/snolh_full_data.rda")
```

##### 1d.1. The cleaned full dataset is saved as the .Rda file `data/raw_data/snolh_full_data.rda`, which can be loaded independently for downstream analyses. The associated R object is called "full_data".
