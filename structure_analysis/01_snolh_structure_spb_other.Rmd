...
In this step, we are filtering the metadata and SNP genotype data to only include samples of interest for analysis of population structure and hybridization between Spotted Bass and all other Interior Highland species. For this analysis, these data will include all individuals across the whole dataset, but only SNP loci that were found to be diagnostic between Spotted Bass and all other Interior Highland Species

##### 1b.1. Filter metadata; run the Rmd chunk below:

##### Filter metadata to only include Spotted Bass and all other Interior Highlands species
```{r}
spb_other_metadata <- metadata # Spotted Bass and all other Interior Highland Bass 
```
