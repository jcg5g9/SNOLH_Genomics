...
```{r}
## get metadata for cbinding later
...
save(spb_other, file = "data/processed_genotype_data/spb_other.rda")
...
##### Generate batch commands: `code/structure_code/batch_cmd_lists/spb_other_structure_batch_cmd_list.txt`
```{r}
# N(pops) = 25
...
cat("", file="code/structure_code/batch_cmd_lists/spb_other_structure_batch_cmd_list.txt")
...
for(ii in 1:nrow(nk)) {
  ...
  for(aa in 1:nrow(nreps)) {
    ...
    cat(paste(structure_call, "-K ", nk[ii,], param_files, input, output,
      ...
      "\n", 
      file=paste("code/structure_code/batch_cmd_lists/spb_other_structure_batch_cmd_list.txt"), # name file to store list
      append=TRUE)
  }
...
##### Generate batch commands: `code/structure_code/shell_scripts/spb_other_structure.sh`
```{r}
#!/bin/bash
#-------------------------------------------------------------------------------
#  SBATCH CONFIG
...
<b>SPB and all other Interior Highlands populations:</b> 26 <br>
...
<b>SPB and all other Interior Highlands populations:</b> 482 <br>
