---
title: "Analysis 2 - Step 2: Hybridization between Spotted Bass and Central Interior Highlands Species"
author: "Joe Gunn"
date: "2022-08-13"
...
## Diagnostic loci for SPB vs. SMBC
...
colnames(spb_smbc_k2) <- c("River", "SMBC_ancestry", "Spotted_Bass_ancestry")
...
colnames(spb_smbc_pofz) <- c("pure_spb","pure_cih","f1","f2","bc_spb","bc_cih")
...
spb_smbc_pofz$Structure_Num <- factor(spb_smbc_pofz$Structure_Num, levels = unique(spb_smbc_pofz$Structure_Num))
...
ggplot(spb_smbc_pofz, aes(x = Structure_Num, y = probability, fill = hybrid_category)) + 
