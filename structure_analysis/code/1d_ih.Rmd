...
```{r}
# DeltaK results
pdf("../figures/structure_figures/deltak_plots/1d_ih_deltaK.pdf", width=8, height=5)
...
ih_k3 <- as.data.frame(ih_k3)

colnames(ih_k3) <- c("neosho_bass", "ouachita_bass", "little_river_bass")

ih_k3 <- cbind(ih_metadata, ih_k3)

write_xlsx(ih_k3, "/Users/joegunn/Desktop/interior_highlands_structure.xlsx")
...
pdf("../figures/newhybrids_figures/neosho_little.pdf", width=120, height=12)
...
pdf("../figures/newhybrids_figures/neosho_ouachita.pdf", width=120, height=12)
...
pdf("../figures/newhybrids_figures/little_ouachita.pdf", width=120, height=12)
