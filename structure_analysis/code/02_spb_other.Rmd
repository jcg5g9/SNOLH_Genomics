...
##### STRUCTURE results of SPB and all other Cenetral Interior Highlands populations: 1) `02_spb_other_deltaK.pdf` and 2) `02_spb_other_k2.pdf`
```{r}
# DeltaK results
...
#### 2f: Analyze ancestry proportions from Spotted Bass for all river populations in the Cenetral Interior Highlands; run the Rmd cbhunk below:
