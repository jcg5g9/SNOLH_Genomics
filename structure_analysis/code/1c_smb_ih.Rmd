...
```{r}
# DeltaK results
pdf("../figures/structure_figures/deltak_plots/1c_smb_ih_deltaK.pdf", width=8, height=5)
...
pdf("../figures/newhybrids_figures/1c_smb_ih.pdf", width=120, height=12)
