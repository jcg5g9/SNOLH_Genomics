---
title: "Analysis 2 - Step 3: Hybridization between Smallmouth Bass and Interior Highlands Species"
author: "Joe Gunn"
date: "2022-08-13"
...
#### 1a: Load in fully filtered dataset ('full_data') and list of hybrids detected between Spotted Bass and all other Interior Highlands fish ('spb_other_hybrids'); run the Rmd chunk below to load in all data.
...
smb_ih_k3_data <- as.data.frame(smb_ih_k3)

smb_ih_k3_data <- cbind(smb_ih_metadata, smb_ih_k3_data)

write_xlsx(smb_ih_k3_data, "/Users/joegunn/Desktop/smb_ih_structure_k3.xlsx")
