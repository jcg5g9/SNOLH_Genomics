...
##### STRUCTURE results of SMB and all other Central Interior Highlands populations
```{r}
# DeltaK results
...
#### 2f: Analyze ancestry proportions from Smallmouth Bass for all river populations in the Central Interior Highlands; run the Rmd cbhunk below:
In this step, we summarize ancestry proportions for each river calculated in STRUCTURE. Specifically, we calculate the average Spotted Bass ancestry across rivers
