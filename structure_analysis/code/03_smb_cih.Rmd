...
```{r}
## Filter out Spotted Bass from genotype data
smb_cih_snps <- full_data %>%
  filter(Putative_Taxon != "Spotted")

# Remove hybrids detected with Spotted Bass (Analysis 2, Step 1b (1b_spb_other.Rmd))
smb_cih_snps <- smb_cih_snps[ ! smb_cih_snps$Structure_Num %in% spb_other_hybrids, ]

# Get only Smallmouth Bass diagnostic SNP loci (N_SM)
...
plotQ(smb_cih_k3,
      ...
      barbordersize = 0.1, 
      clustercol = c("darkorchid1", "deepskyblue1","forestgreen"),
      exportplot = T,
      imgtype = "pdf",
      height = 10, 
      width = 100,
...
plotQ(smb_cih_k4,
      ...
      barbordercolour = "black",
      barbordersize = 0.1, 
      clustercol = c("darkorchid1", "deepskyblue1", "forestgreen","goldenrod1"),
      exportplot = T,
      imgtype = "pdf",
      height = 10, 
      width = 100,
...
plotQ(smb_cih_k2,
      ...
      barbordercolour = "black",
      barbordersize = 0.1, 
      clustercol = c("darkorchid1", "deepskyblue1"),
      exportplot = T,
      imgtype = "pdf",
      height = 10, 
      width = 100,
...
colnames(smb_cih_pofz) <- c("pure_ih","pure_smb","f1","f2","bc_cih","bc_smb")
...
smb_cih_pofz$Structure_Num <- factor(smb_cih_pofz$Structure_Num, levels = unique(smb_cih_pofz$Structure_Num))
...
smb_cih_pure <- rbind(smb_cih_pure_ih, smb_cih_pure_smb)
