---
title: "Analysis 2 - Step 3: Hybridization between Smallmouth Bass and Central Interior Highlands Species"
author: "Joe Gunn"
date: "2022-08-13"
...
We found strongest support for K=3, but also support for K=4 using the deltak metric. We found universal support for K=4 using the Puechmaille metric. We therefore present result for K=3 and K=4 in Step 2g.5 below.
...
plotQ(smb_cih_k3,
      ...
      barbordersize = 0.1, 
      clustercol = c("#4393C3","#C7EAE5","#35978F"),
      exportplot = T,
      imgtype = "pdf",
      height = 10, 
      width = 100,
...
plotQ(smb_cih_k4,
      ...
      barbordercolour = "black",
      barbordersize = 0.1, 
      clustercol = c("#4393C3","#C7EAE5","#35978F","#80CDC1"),
      exportplot = T,
      imgtype = "pdf",
      height = 10, 
      width = 100,
...
# Convert Structure_Num column to factor
smb_cih_pofz <- smb_cih_pofz %>%
  mutate(Structure_Num = factor(Structure_Num))

# Reorder Structure_Num to be in the same order as Rivers (same as presented in Structure q plot)
smb_cih_pofz <- smb_cih_pofz %>% 
  mutate(Structure_Num = fct_reorder(Structure_Num, as.integer(River)))
...
ggplot(smb_cih_pofz, aes(x = Structure_Num, y = probability, fill = hybrid_category)) + 
