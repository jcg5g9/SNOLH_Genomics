...
smb_cih_metadata <- smb_cih_metadata[ ! smb_cih_metadata$Structure_Num %in% spb_smbc_hybrids, ] 
...
smb_cih_snps <- smb_cih_snps[ ! smb_cih_snps$Structure_Num %in% spb_smbc_hybrids, ]
...
smb_cih_individuals <- data.frame(indiv = as.character(smb_cih_metadata$Structure_Num))
...
ggplot(smb_cih_pofz, aes(x = Analysis_order_W2E_U2D_corrected, y = probability, fill = hybrid_category)) + 
...
smb_cih_pure <- rbind(smb_cih_pure_cih, smb_cih_pure_smb)

# Generate list of "hybrid" samples (f1, f2, and backcrosses)
smb_cih_hybrids <- rbind(smb_cih_f1, smb_cih_f2, smb_cih_bc_ih, smb_cih_bc_smb)
