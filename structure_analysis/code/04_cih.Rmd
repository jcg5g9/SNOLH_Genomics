...
##### Filter metadata to only include Central Interior Highlands species (excluding Spotted Bass and Smallmouth Bass)
```{r}
...
<b>Details on Central Interior Highlands only dataset:</b> <br>
...
```{r}
# Generate structure file for Central Interior Highlands Bass only, excluding Smallmouth Bass
...
<b>Details on Central Interior Highlands populations:</b> <br>
...
##### deltak results for all Central Interior Highlands populations: `04_ih_deltak.pdf`
```{r}
# DeltaK results
...
We found strongest support for K=3 using the deltaK metric. We found universal support for K=8 using the Puechmaille metric. We therefore present result for K=3 and K=8 in Step 2g.5 below.

##### 2g.5. Plot STRUCTURE runs at best K value (K=3 and K=8) for each analysis; run the rmd chunk below.

##### STRUCTURE results for Central Interior Highlands populations: 1) `04_ih_k3.pdf` and 2) `04_ih_k8.pdf`
```{r}
...
plotQ(ih_k8,
      ...
      barbordercolour = "black",
      barbordersize = 0.1, 
      clustercol = c("deepskyblue1", "forestgreen","goldenrod1", "sienna4", "lightyellow", "chocolate1", "mediumpurple","lightgreen"),
      exportplot = T,
      imgtype = "pdf",
      height = 10, 
      width = 100,
      outputfilename = "04_ih_k8",
      exportpath = "../figures/structure_figures/q_plots")
```
...
##### 3a.1. Parse the genepop dataset for Central Interior Highlands species into three pairwise comparison datasets before running NEWHYBRIDS analysis
...
save(neosho_little_pofz, file = "../data/newhybrids_data/output_data/neosho_little_output/neosho_little_pofz.rda")
save(neosho_ouachita_pofz, file = "../data/newhybrids_data/output_data/neosho_ouachita_output/neosho_ouachita_pofz.rda")
save(little_ouachita_pofz, file = "../data/newhybrids_data/output_data/little_ouachita_output/little_ouachita_pofz.rda")
