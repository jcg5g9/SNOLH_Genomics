...
#### 3a. Identify SNP markers with missing genotype call rate higher than 5% across samples and remove from the genotype dataset; run the Rmd chunk below:
...
NEO_locus4464_128<br>				
NEO_locus17912_112<br>				
NEO_locus21188_55<br>				
NEO_locus859_264<br>				
OULR_locus2600_102<br>				
OULR_locus10488_266<br>				
OUOU_locus11827_147<br>				
OUOU_locus6374_33<br>				
OUOU_locus14694_64<br>
OUOU_locus5365_241<br>				
OUOU_locus4074_84<br>				
OUOU_locus15807_109<br>				
OUOU_locus14857_59<br>				
OULR_locus1841_280<br>

<i>N</i><sub>(sample)</sub> = 484 <br>
<i>N</i><sub>(loci)</sub> = 177 <br>

#### 3b: Identify samples with missing genotype call rate higher than 5% across SNP markers (AFTER removing poor quality SNPs in step 3a above) and remove from genotype data and metadata; run the Rmd chunk below:
...
filtered_sample_missing <- cbind(mdata_01_filter_shoal, filtered_sample_missing)

# Calculate rate of missing genotypes per sample (number of missing genotypes divided by total number of SNP loci (186 after poor quality SNP filtering filtering))
filtered_sample_missing <- filtered_sample_missing %>%
  mutate(missing_rate = filtered_sample_missing/177)
...
ave_sample_missing <- filtered_sample_missing %>%
  group_by(Putative_Taxon) %>%
  summarize(mean = mean(filtered_sample_missing), 
            sd = sd(filtered_sample_missing), 
            var = sd^2, 
            n = n(), 
            se = sd/sqrt(n)) %>%
  as.data.frame()
