...
# Arrange missingness in descending order
spb_smbc_sample_missing %>%
  arrange(desc(missing_rate))
...
<b>Average number of genotypes missing in SMB-C:</b> 0.07708779 <br>
<b>Average SNP missingness rate in SMB-C:</b> 0.005139186<br>
<b>Average number of genotypes missing in SPB:</b> 0.80000000 <br>
<b>Average SNP missingness rate in SPB:</b> 0.053333333<br>
...
<b>Average number of genotypes missing in CIH:</b> 0.1351351 <br>
<b>Average SNP missingness rate in CIH:</b> 0.004095004<br>
<b>Average number of genotypes missing in SMB:</b> 1.0434783 <br>
<b>Average SNP missingness rate in SMB:</b> 0.031620553<br>
...
<b>Average number of genotypes missing in NB:</b> 0.1351351 <br>
<b>Average SNP missingness rate in NB:</b> 0.004095004<br>
<b>Average number of genotypes missing in OB:</b> 1.0434783 <br>
<b>Average SNP missingness rate in OB:</b> 0.031620553<br>
<b>Average number of genotypes missing in LRB:</b> 1.0434783 <br>
<b>Average SNP missingness rate in LRB:</b> 0.031620553<br>
...
# Save group factor
save(spb_smbc_genotypes_missing_spp, file = "data/validation_data/spb_smbc_genotypes_missing_spp.rda")
...
# Save group factor
save(spb_smbc_genotypes_no_missing_spp, file = "data/validation_data/spb_smbc_genotypes_no_missing_spp.rda")
...
```{r}
# Load SPB data (with missing genotypes) and group factor
load("data/validation_data/spb_smbc_genotypes_missing.Rda")
load("data/validation_data/spb_smbc_genotypes_missing_spp.Rda")

# Load SPB data (without missing genotypes)
load("data/validation_data/spb_smbc_genotypes_no_missing.Rda")
load("data/validation_data/spb_smbc_genotypes_no_missing_spp.Rda")
...
##### Run dapc:
```{r}
# Load in genind object for SPB vs SMB-C (with missing data) and group factor
...
# Get plot for PCA accumulation curve for SPB vs. SMB-C with missing genotypes
pdf("figures/spb_smbc_missing_pca.pdf", width=6, height=5)

scatter(missing_dapc,
        scree.pca = T,
        posi.pca = "topright")
...
# Get plot for PCA accumulation curve for SPB vs. SMB-C without missing genotypes
pdf("figures/spb_smbc_no_missing_pca.pdf", width=6, height=5)

scatter(no_missing_dapc,
        scree.pca = T,
        posi.pca = "topright")
...
```{r}
# Load DAPC for SPB data (with missing genotypes) and group factor
load("data/validation_data/spb_smbc_missing_dapc.Rda")
load("data/validation_data/spb_smbc_genotypes_missing_spp.Rda")

# Load DAPC for SPB data (without missing genotypes) and group factor
...
# Save group factor
save(smb_cih_genotypes_missing_spp, file = "data/validation_data/smb_cih_genotypes_missing_spp.rda")
...
# Save group factor
save(smb_cih_genotypes_no_missing_spp, file = "data/validation_data/smb_cih_genotypes_no_missing_spp.rda")
...
##### Convert to genind and scale data:
```{r}
# Load SMB data (with missing genotypes) and group factor
load("data/validation_data/smb_cih_genotypes_missing.Rda")
load("data/validation_data/smb_cih_genotypes_missing_spp.Rda")

# Load SMB data (without missing genotypes) and group factor
load("data/validation_data/smb_cih_genotypes_no_missing.Rda")
load("data/validation_data/smb_cih_genotypes_no_missing_spp.Rda")
...
# Load in genind object for SMB vs CIH (without missing data) and group factor
...
# Get plot for PCA accumulation curve for SMB vs. CIH with missing genotypes
pdf("figures/smb_cih_missing_pca.pdf", width=6, height=5)
...
# Get plot for PCA accumulation curve for SMB vs. CIH without missing genotypes
pdf("figures/smb_cih_no_missing_pca.pdf", width=6, height=5)
...
##### Extract LD results from DAPC:
```{r}
# Load DAPC for SMB data (with missing genotypes) and group factor
load("data/validation_data/smb_cih_missing_dapc.Rda")
load("data/validation_data/smb_cih_genotypes_missing_spp.Rda")

# Load DAPC for SMB data (without missing genotypes) and group factor
...
save(cih_genotypes_missing_spp, file = "data/validation_data/cih_genotypes_missing_spp.Rda")
...
save(cih_genotypes_missing_spp, file = "data/validation_data/cih_genotypes_no_missing_spp.Rda")
...
##### Convert to genind and scale data:
```{r}
# Load CIH data (with missing genotypes) and group factor
load("data/validation_data/cih_genotypes_missing.Rda")
load("data/validation_data/cih_genotypes_missing_spp.Rda")

# Load CIH data (without missing genotypes) and group factor
load("data/validation_data/cih_genotypes_no_missing.Rda")
load("data/validation_data/cih_genotypes_no_missing_spp.Rda")
...
##### Run dapc:
```{r}
# Load in genind object for CIH (with missing data) and group factor
load("data/validation_data/cih_missing_data_genind.Rda")
load("data/validation_data/cih_genotypes_missing_spp.Rda")

# Load in genind object for CIH (without missing data) and group factor
...
missing_dapc <- dapc(missing_genind, cih_genotypes_missing_spp) # 100 PCs used

# Get plot for PCA accumulation curve for CIH with missing genotypes
pdf("figures/cih_missing_pca.pdf", width=6, height=5)
...
no_missing_dapc <- dapc(no_missing_genind, cih_genotypes_no_missing_spp) # 40 PCs used

# Get plot for PCA accumulation curve for CIH without missing genotypes
pdf("figures/cih_no_missing_pca.pdf", width=6, height=5)
...
##### Extract LD results from DAPC:
```{r}
# Load DAPC for CIH data (with missing genotypes) and group factor
...
# Modify column names
colnames(missing_ld) <- c("group","LD1","LD2")
...
# Modify column names
colnames(no_missing_ld) <- c("group","LD1","LD2")
...
missing <- ggplot(missing_ld, aes(x = LD1, y = LD2, fill = group)) +
  geom_point(size = 4, pch = 21, color = "black", show.legend = F) +
  theme_set(theme_cowplot(12)) +
  labs(x = "LD1", y = "LD2") +
...
no_missing <- ggplot(no_missing_ld, aes(x = LD1, LD2, fill = group)) +
  geom_point(size = 4, pch = 21, color = "black", show.legend = F) +
  theme_set(theme_cowplot(12)) +
  labs(x = "LD1", y = "LD2") +
  scale_fill_manual(values = c("#E6AB02","#7570B3","#E7298A")) +
